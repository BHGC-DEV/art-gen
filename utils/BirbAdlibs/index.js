...
const {BloodTypes} = require(`${basePath}/utils/BirbAdlibs/BloodTypes.js`);
const {CommonAdjectives} = require(`${basePath}/utils/BirbAdlibs/CommonAdjectives.js`);
...
const {Jobs} = require(`${basePath}/utils/BirbAdlibs/Jobs.js`);
const {MaleNames} = require(`${basePath}/utils/BirbAdlibs/MaleNames.js`);
const {NightThings} = require(`${basePath}/utils/BirbAdlibs/NightThings.js`);
